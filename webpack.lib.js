...
const plugins = [
	// plugin that insert options to loaders
...
module.exports = {
	...
	output: {
		//extract to app.js, vendor.js existed in entry
		...
		minimizer: [
			...
			new TerserPlugin({
				...
				terserOptions: {
					...
					compress: {
						warnings: false,
						unused: true, // tree shaking(not include no-used module of export modules)
					},
					ecma: 6,
					mangle: true,
					unused: true,
